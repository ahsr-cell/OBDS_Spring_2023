...
## Change to --patition=batch after the OBDS_course
...
## -time=24-3:00:00 denotes 24 days and 3 hours
#SBATCH --time=3:00:00
...
samtools index -@ 4 ERR1755082.bam 
samtools idxstats ERR1755082.bam > ERR1755082.idxstats
samtools flagstat ERR1755082.bam > ERR1755082.flagstat 
